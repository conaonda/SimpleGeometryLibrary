...
{
	public class PriorityQueue<TItem, TPriority> : IPriorityQueue<TItem, TPriority> where TPriority : IComparable, IConvertible
    {
		...
		public TItem Dequeue()
		{
			...
			queue[0].Priority = Number<TPriority>.MinValue;
